    ...
    public partial class LibraryView : UserControl
    {
        ...
        public LibraryView()
        {
            ...
            if (DataContext is LibraryViewModel libraryViewModel)
            {
                ...
                var field = typeof(LibraryViewModel).GetField("_navigationService", 
                    System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
                _navigationService = field?.GetValue(libraryViewModel) as INavigationService;
            }
        }
        ...
        private async void OnBorrowButtonClicked(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                {
                    Console.WriteLine($"LibraryView - OnBorrowButtonClicked: {book.Id} - {book.Title}");
                    
                    // Get the navigation service from ViewModel if not already cached
                    INavigationService? navigationService = _navigationService;
                    
                    if (navigationService == null && DataContext is LibraryViewModel viewModel)
                    {
                        // Access the navigation service from the ViewModel if possible
                        var field = typeof(LibraryViewModel).GetField("_navigationService", 
                            System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
